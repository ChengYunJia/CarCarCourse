...
const int moveSteps = 800; // 测试电机运行使用的运行步数
...
bool stepperControl( AccelStepper theStepper, int target, int speed ){
    ...
    if( theStepper.currentPosition() == target ){
        return 1;
    }else return 0;
};
...
void stepperSetup()
{
    ...
    stepper1.setAcceleration(50.0); // 设置电机加速度20.0
    stepper2.setMaxSpeed(300.0);    // 设置电机最大速度300
    stepper2.setAcceleration(50.0); // 设置电机加速度20.0
    stepper3.setMaxSpeed(300.0);    // 设置电机最大速度300
    stepper3.setAcceleration(50.0); // 设置电机加速度20.0
    stepper4.setMaxSpeed(300.0);    // 设置电机最大速度300
    stepper4.setAcceleration(50.0); // 设置电机加速度20.0
}
